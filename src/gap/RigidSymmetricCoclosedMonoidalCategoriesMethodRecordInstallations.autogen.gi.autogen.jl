...
@InstallMethod( AddCoRankMorphism,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoRankMorphism", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddCoTraceMap,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoTraceMap", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddCoclosedCoevaluationForCoDual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoclosedCoevaluationForCoDual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddCoclosedCoevaluationForCoDualWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoclosedCoevaluationForCoDualWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddInternalCoHomTensorProductCompatibilityMorphismInverse,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "InternalCoHomTensorProductCompatibilityMorphismInverse", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddInternalCoHomTensorProductCompatibilityMorphismInverseWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "InternalCoHomTensorProductCompatibilityMorphismInverseWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddIsomorphismFromInternalCoHomToTensorProductWithCoDualObject,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "IsomorphismFromInternalCoHomToTensorProductWithCoDualObject", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddIsomorphismFromTensorProductWithCoDualObjectToInternalCoHom,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "IsomorphismFromTensorProductWithCoDualObjectToInternalCoHom", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromTensorProductToInternalCoHom,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromTensorProductToInternalCoHom", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromTensorProductToInternalCoHomWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromTensorProductToInternalCoHomWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismToCoBidual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismToCoBidual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismToCoBidualWithGivenCoBidual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismToCoBidualWithGivenCoBidual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
