...
@InstallMethod( AddCoevaluationForDual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoevaluationForDual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddCoevaluationForDualWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "CoevaluationForDualWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddIsomorphismFromInternalHomToTensorProductWithDualObject,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "IsomorphismFromInternalHomToTensorProductWithDualObject", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddIsomorphismFromTensorProductWithDualObjectToInternalHom,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "IsomorphismFromTensorProductWithDualObjectToInternalHom", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromBidual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromBidual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromBidualWithGivenBidual,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromBidualWithGivenBidual", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromInternalHomToTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromInternalHomToTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddMorphismFromInternalHomToTensorProductWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "MorphismFromInternalHomToTensorProductWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRankMorphism,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RankMorphism", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddTensorProductInternalHomCompatibilityMorphismInverse,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "TensorProductInternalHomCompatibilityMorphismInverse", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddTensorProductInternalHomCompatibilityMorphismInverseWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "TensorProductInternalHomCompatibilityMorphismInverseWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddTraceMap,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "TraceMap", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
