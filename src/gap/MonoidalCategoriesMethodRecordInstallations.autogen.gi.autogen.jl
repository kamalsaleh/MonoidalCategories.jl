...
@InstallMethod( AddAssociatorLeftToRight,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "AssociatorLeftToRight", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddAssociatorLeftToRightWithGivenTensorProducts,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "AssociatorLeftToRightWithGivenTensorProducts", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddAssociatorRightToLeft,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "AssociatorRightToLeft", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddAssociatorRightToLeftWithGivenTensorProducts,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "AssociatorRightToLeftWithGivenTensorProducts", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftUnitor,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftUnitor", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftUnitorInverse,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftUnitorInverse", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftUnitorInverseWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftUnitorInverseWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftUnitorWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftUnitorWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightUnitor,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightUnitor", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightUnitorInverse,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightUnitorInverse", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightUnitorInverseWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightUnitorInverseWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightUnitorWithGivenTensorProduct,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightUnitorWithGivenTensorProduct", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddTensorProductOnMorphisms,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "TensorProductOnMorphisms", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddTensorProductOnMorphismsWithGivenTensorProducts,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "TensorProductOnMorphismsWithGivenTensorProducts", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
